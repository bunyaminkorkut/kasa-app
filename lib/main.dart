...
import 'package:kasa_app/infrastructure/photo/impl_photo_service.dart'; // <-- bunu ekle
  ...
  Widget build(BuildContext context) {
    return MultiRepositoryProvider(
      providers: [
        ...
        RepositoryProvider<IPhotoRepository>(
      ...
      child: MultiBlocProvider(
        providers: [
          ...
          BlocProvider<GroupBloc>(
            create: (context) =>
                GroupBloc(context.read<IGroupRepository>()),
          ),
          BlocProvider<PhotoCubit>(
            create: (context) =>
                PhotoCubit(context.read<IPhotoRepository>()),
          ),
        ],
        child: MaterialApp(
